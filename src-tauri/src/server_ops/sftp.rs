...
const SFTP_SUBSYSTEM_REPLY_TIMEOUT: Duration = Duration::from_secs(15);
...
fn entry_type_from_file_type(file_type: FileType) -> SftpEntryType {
    match file_type {
...
async fn finish_atomic_write_with_fallback<R, D, U, L>(
    rename_temp: R,
...
async fn inspect_local_upload_source(path: &Path) -> AppResult<LocalUploadSource> {
