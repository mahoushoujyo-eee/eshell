...
pub(crate) fn validate_jump_chain(depth: usize, visited: &[String], config_id: &str) -> AppResult<()> {
...
pub(crate) fn client_config() -> Arc<Config> {
...
pub(crate) fn endpoint_of(config: &SshConfig) -> String {
