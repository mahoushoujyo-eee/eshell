...
import SftpCreateEntryDialog from "./components/SftpCreateEntryDialog";
import SftpDeleteConfirmDialog from "./components/SftpDeleteConfirmDialog";
import SftpEntriesPane from "./components/SftpEntriesPane";
import SftpEntryContextMenu from "./components/SftpEntryContextMenu";
import SftpRenameEntryDialog from "./components/SftpRenameEntryDialog";
import SftpTextOpenConfirmDialog from "./components/SftpTextOpenConfirmDialog";
import SftpToolbar from "./components/SftpToolbar";
import SftpTransferQueue from "./components/SftpTransferQueue";
import SftpTreePane from "./components/SftpTreePane";
import { getSftpTextOpenGuard } from "./components/sftpOpenGuard";
import { getDirectoryNodes } from "./components/sftpPanelUtils";
...
export default function SftpPanel({
  ...
  const configureDownloadDirectory = async () => {
    ...
    const selected = await api?.sftp?.selectDownloadDir(current);
