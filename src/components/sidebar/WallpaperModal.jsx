import { Check, Image, Trash2, Upload, X } from "lucide-react";
...
export default function WallpaperModal({ open, onClose, wallpaper, onChangeWallpaper }) {
  ...
  const choosePreset = (id) => {
    setUploadError("");
    onChangeWallpaper({ type: "preset", id });
    onClose();
  };
            ...
            <div className="rounded-2xl border border-border/75 bg-panel/80 p-3">
              ...
              {normalized.type === "custom" ? (
                <button
                  ...
                  onClick={() => {
                    onChangeWallpaper(DEFAULT_WALLPAPER);
                    onClose();
                  }}
                >
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <div className="text-xs text-muted">
                Upload a JPG, PNG, or WebP under 1.5MB. It will be stored locally for this desktop app.
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {uploading ? "Importing..." : "Upload Wallpaper"}
              </button>
            </div>
          </div>
